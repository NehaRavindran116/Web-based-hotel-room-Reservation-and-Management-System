...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@naturesresort@gmail.com</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>NATURE'S EDGE <span>NATURE'S EDGE RESORT</span></h4>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/nneha.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/nithya.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Navya.webp" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Nooraain.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<h4>Nithya R</h4>
							...
							<p>Before joining NATURE'S EDGE RESORT, first as Reservation Agent and now Receptionist, Nasra had notched up a vast amount of experience in the hotel and hospitality sector.Skilled in guest relations, customer service and management software systems, Nasra’s all-round knowledge makes her a valuable asset to the company. </p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/clerk kent.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
